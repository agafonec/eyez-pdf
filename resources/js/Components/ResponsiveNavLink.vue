...
const classes = computed(() =>
    props.active
        ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-green-400 text-center text-base font-medium text-green-500 bg-green-50 focus:outline-none focus:text-green-600 focus:bg-green-100 focus:border-green-700 transition duration-150 ease-in-out'
